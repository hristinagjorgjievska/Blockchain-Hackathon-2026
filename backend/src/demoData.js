...
export const DEMO_VIOLATIONS = [
  ...
  priced({
    ...
    street: {
      mk: 'Бул. Кузман Ј. Питу',
      en: 'Kuzman J. Pitu Blvd.',
      sr: 'Булевар Кузман Ј. Питу',
    },
    city: { mk: 'Скопје', en: 'Skopje', sr: 'Скопље' },
  ...
  priced({
    ...
    street: {
      mk: 'Бул. Борис Трајковски',
      en: 'Boris Trajkovski Blvd.',
      sr: 'Булевар Борис Трајковски',
    },
    city: { mk: 'Скопје', en: 'Skopje', sr: 'Скопље' },
  ...
  priced({
    ...
    street: {
      mk: 'Бул. Александар Македонски',
      en: 'Aleksandar Makedonski Blvd.',
      sr: 'Булевар Александар Македонски',
    },
    city: { mk: 'Скопје', en: 'Skopje', sr: 'Скопље' },
  ...
  priced({
    ...
    street: {
      mk: 'Ул. Димитрие Чуповски',
      en: 'Dimitrie Chupovski St.',
      sr: 'Улица Димитрије Чуповски',
    },
    city: { mk: 'Скопје', en: 'Skopje', sr: 'Скопље' },
  ...
  priced({
    ...
    legalNote: {
      ...
      sr: 'Паркирање на месту намењеном особама са инвалидитетом: 50 EUR. Могуће је одношење паук-službом уз додатне трошкове.',
    },
  }),
