...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'Да. Ова е единствениот официјален портал на SafeChain MK. Внесувајте кодови само овде — никогаш преку линк од SMS или е-мајл.',
  },
  {
    question: 'Добив SMS со линк за плаќање. Дали е легитимен?',
    answer:
      'Не. SafeChain никогаш не испраќа линкови во SMS. Ако добивте порака со линк, тоа е обид за измама. Игнорирајте ја и пријавете ја на 192.',
  },
  {
